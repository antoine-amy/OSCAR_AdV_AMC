...
G1 = Grid(10,0.4); %128 de base, 10 pour etre plus rapide
...
PRM = Interface(G1,'RoC',1430,'CA',0.33,'T',0.05,'L',0E-6); % Nominal 1430
PRM = Add_Tilt(PRM,0E-9); % Add a tilt in the vertical direction to the PRM
