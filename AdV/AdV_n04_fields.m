...
saveas(gcf,filename);
figure(1450+100); E_Plot(AV_DR.Field_circ,'SB','SB_num',2)
filename = ['56MHz_' vstring '_0-ref'];
saveas(gcf,filename);
figure(1450+200); E_Plot(AV_DR.Field_circ,'carrier')
filename = ['Carrier_' vstring '_0-ref'];
title('Carrier')
saveas(gcf,filename);

Expand_HOM(AV_DR.Field_POP,16,'display','pyramid')
