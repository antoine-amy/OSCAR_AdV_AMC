...
% E_input = E_Field(G1,'w0',335E-6,'Z',-0.035);
load('Results/AV_DR.mat');
%E_input = AV_DR.Field_POP;
E_input = E_Field(G1,'w0',335E-6,'Z',-0.035);
...
I(3) = Interface(G1,'RoC',10.5E-2,'CA',0.02,'T',10E-6,'AoI',13);    % 'AoI'is for the angle of incidence in degree
I(4) = Interface(G1,'RoC',0,'CA',0.02,'T',10E-6,'AoI',13);
